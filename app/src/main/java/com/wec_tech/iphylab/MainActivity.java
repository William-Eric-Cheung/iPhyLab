...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button recordButton = (Button) findViewById(R.id.exp_record_button);
        Button selectButton = (Button) findViewById(R.id.exp_select_button);

        recordButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, ExpRecordActivity.class);
        ...
        selectButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, ExpSelectActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_record_button) {
            ...
            Intent intent = new Intent(MainActivity.this, ExpDocumentActivity.class);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_state) {
            Intent intent = new Intent(MainActivity.this, ExpStateActivity.class);
            startActivity(intent);
            finish();
